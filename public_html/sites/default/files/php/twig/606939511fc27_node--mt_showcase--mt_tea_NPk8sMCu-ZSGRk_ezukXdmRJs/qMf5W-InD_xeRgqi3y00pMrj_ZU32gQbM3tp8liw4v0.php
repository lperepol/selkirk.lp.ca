...
/* themes/custom/teamplus/templates/node--mt_showcase--mt_teaser_tile.html.twig */
class __TwigTemplate_89b81e466debe4e041cc530f407b83d456257541dea2aa6a82164429c8b5cc29 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 14, $this->source)))) : (""))];
        // line 17
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("teamplus/node-view-mode-teaser-tile"), "html", null, true);
        echo "
";
        // line 18
        ...
        // line 26
        $context["submitted_day"] = call_user_func_array($this->env->getFilter('format_date')->getCallable(), [$this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 26), 26, $this->source), "custom", "d"]);
        // line 27
        $context["submitted_month"] = call_user_func_array($this->env->getFilter('format_date')->getCallable(), [$this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 27), 27, $this->source), "custom", "M, "]);
        // line 28
        $context["submitted_year"] = call_user_func_array($this->env->getFilter('format_date')->getCallable(), [$this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "createdtime", [], "any", false, false, true, 28), 28, $this->source), "custom", "Y"]);
        // line 29
        $context["read_more"] = null;
        // line 30
        $this->loadTemplate("@teamplus/partials/_mt-teaser-tile.html.twig", "themes/custom/teamplus/templates/node--mt_showcase--mt_teaser_tile.html.twig", 30)->display($context);
    }

    public function getTemplateName()
    {
        return "themes/custom/teamplus/templates/node--mt_showcase--mt_teaser_tile.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/teamplus/templates/node--mt_showcase--mt_teaser_tile.html.twig", "/var/www/selkirk.lp.ca/public_html/themes/custom/teamplus/templates/node--mt_showcase--mt_teaser_tile.html.twig");
    }
