      ...
      $(context).find('.link--smooth-scroll').once('inPageNavInit').click(function(e) {
        ...
        if (anchorDestination) {
          ...
          $('html, body').animate({
            ...
            scrollTop: $(anchorDestination).offset().top - drupalSettings.teamplus.inPageNavigation.inPageNavigationOffset - adminHeight
          }, 1000);
  ...
  Drupal.behaviors.inPageNavScrollspy = {
    attach: function (context, settings) {
      ...
      $(context).find('body').scrollspy({
        ...
        offset: drupalSettings.teamplus.inPageNavigation.inPageNavigationOffset + toolbarHeight + 1
      });
    }
  };
})(jQuery, Drupal, drupalSettings);
